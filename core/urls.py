...
urlpatterns = [
    ...
    path('add_to_cart/<variant_id>/', add_to_cart, name='add_to_cart'),
    # path('remove_from_cart/<slug>/', remove_from_cart, name='remove_from_cart'),
    path('remove_from_cart/<variant_id>/', remove_from_cart, name='remove_from_cart'),
    path('order_summary/', OrderSummaryView.as_view(), name='order_summary'),
    # path('remove_single_item_from_cart/<slug>/', remove_single_item_from_cart, name='remove_single_item_from_cart'),
    path('remove_single_item_from_cart/<variant_id>/', remove_single_item_from_cart, name='remove_single_item_from_cart'),
