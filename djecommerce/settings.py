...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'd3bnqqe27kearg'),
        'USER': os.environ.get('DB_USER', 'gppyigmxlbgdkl'),
        'PASSWORD': os.environ.get('DB_PASSWORD', '0fb803b389f58d1dcc3e8da20eb68a5715fc50f38e1e6334a2667d6fc84b03c7'),
        'HOST': os.environ.get('DB_HOST', 'ec2-35-171-250-21.compute-1.amazonaws.com'),
