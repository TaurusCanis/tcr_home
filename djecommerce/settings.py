...
print("BRAINTREE_PRODUCTION_MERCHANT_ID: ", BRAINTREE_PRODUCTION_MERCHANT_ID)
print("BRAINTREE_PRODUCTION_PUBLIC_KEY: ", BRAINTREE_PRODUCTION_PUBLIC_KEY)
print("BRAINTREE_PRODUCTION_PRIVATE_KEY: ", BRAINTREE_PRODUCTION_PRIVATE_KEY)
