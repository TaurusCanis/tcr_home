...
BRAINTREE_SANDBOX_MERCHANT_ID = os.environ.get('BRAINTREE_SANDBOX_MERCHANT_ID', )
BRAINTREE_SANDBOX_PUBLIC_KEY = os.environ.get('BRAINTREE_SANDBOX_PUBLIC_KEY', )
BRAINTREE_SANDBOX_PRIVATE_KEY = os.environ.get('BRAINTREE_SANDBOX_PRIVATE_KEY', )
