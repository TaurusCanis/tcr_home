...
BRAINTREE_SANDBOX_MERCHANT_ID = os.environ.get('BRAINTREE_PRODUCTION_MERCHANT_ID', )
BRAINTREE_SANDBOX_PUBLIC_KEY = os.environ.get('BRAINTREE_PRODUCTION_PUBLIC_KEY', )
BRAINTREE_SANDBOX_PRIVATE_KEY = os.environ.get('BRAINTREE_PRODUCTION_PRIVATE_KEY', )

print("SECRET_KEY: ", SECRET_KEY)
print("BRAINTREE_SANDBOX_MERCHANT_ID: ", BRAINTREE_SANDBOX_MERCHANT_ID)
print("BRAINTREE_SANDBOX_PUBLIC_KEY: ", BRAINTREE_SANDBOX_PUBLIC_KEY)
print("BRAINTREE_SANDBOX_PRIVATE_KEY: ", BRAINTREE_SANDBOX_PRIVATE_KEY)
